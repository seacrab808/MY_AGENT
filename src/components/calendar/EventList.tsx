          ...
          <li key={event.id}>
            {onSelect ? (
              <button
                ...
                className="w-full min-w-0 flex items-start gap-2 border-2 border-pixel-border rounded-[10px] p-2.5 bg-pixel-bg text-left cursor-pointer hover:-translate-y-0.5 transition-transform"
              >
                {content}
              </button>
            ) : (
              <div className="w-full min-w-0 flex items-start gap-2 border-2 border-pixel-border rounded-[10px] p-2.5 bg-pixel-bg">
                {content}
              </div>
            )}
          </li>
